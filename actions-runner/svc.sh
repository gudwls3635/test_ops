...
SVC_NAME="actions.runner.gudwls3635-test_ops.gimhyeongjin-ui-MacBookPro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (gudwls3635-test_ops.gimhyeongjin-ui-MacBookPro)"
